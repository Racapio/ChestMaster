...
- [Mod Menu](https://modrinth.com/mod/modmenu) config screen: auto-scan, verbose logging, default sort, price mode, price refresh interval
...
Build outputs go to `build/libs/`.
